...
**Status:** frontend UI prototype done; auth works end-to-end; routers scaffolded (501 placeholders); stub services done + UI pages linked to backend; real services being implemented in parallel.
